...
export async function signup(req, res) {
    ...
    try {
        ...
        try {
            ...
            console.log(`Stream user created user: ${newUser.fullName}`);
        } catch (error) {
            console.error("Error in StreamUser during signup:", error);
        }
...
export async function onboard(req, res) {
    try {
        ...
        try {
            ...
            console.log(`Stream user updated user: ${updatedUser.fullName}`);
        } catch (streamError) {
            console.error("Error in StreamUser during onboarding:", streamError);
        }
